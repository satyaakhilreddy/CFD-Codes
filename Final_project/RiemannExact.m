...
t= 0.1644 %input('Insert the time which you want to calculate the solution at (check the velocities'' order of magnitude first!), t= ');
...
npoints= 101 %input('insert the number of points which you want to calculate the solution in, npoints= ');
